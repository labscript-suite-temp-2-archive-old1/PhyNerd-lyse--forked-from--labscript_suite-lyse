...
class RoutineBox(object):
    ...
    def do_analysis(self, filepath):
        ...
        if error:
            ...
            self.to_filebox.put(['done', 100.0, updated_data])
...
class DataFrameModel(QtCore.QObject):
    ...
    @inmain_decorator()
    def update_row(self, filepath, dataframe_already_updated=False, status_percent=None, new_row_data=None, df_row_index=None):
...
class FileBox(object):
    ...
    def do_singleshot_analysis(self, filepath):
        ...
        while True:
            ...
            if signal in ['error', 'progress', updated_data]:
